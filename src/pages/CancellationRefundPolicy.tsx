...
interface CancellationRefundPolicyProps {
  onNavigate?: (page: 'home' | 'products' | 'product-detail' | 'quote' | 'checkout' | 'about' | 'privacy-policy' | 'terms-and-conditions' | 'shipping-policy' | 'cancellation-refund-policy', productId?: string) => void;
}
            ...
            <div className="bg-white/80 backdrop-blur-md border border-white/20 shadow-xl rounded-2xl p-8">
              ...
              <div className="prose prose-lg max-w-none">
                ...
                <ul className="list-disc list-outside pl-6 space-y-3">
                  ...
                  <li className="text-base text-[#1A1A1A]/80 leading-relaxed">
                    <strong className="text-[#4B3A2A]">Logistics Issues:</strong> Delays or complications caused by carrier service disruptions
                  </li>
                  <li className="text-base text-[#1A1A1A]/80 leading-relaxed">
